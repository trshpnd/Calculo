...
\begin{figure}\begin{center}
    ...
    \end{center}
\end{figure}
Este trio de vetores pode ser interpretado como os três lados de um triângulo como na figura \ref{leicossenos}. Da lei dos cossenos, sabemos que a seguinte relação é satisfeita:
